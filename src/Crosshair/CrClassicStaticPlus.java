...
public class CrClassicStaticPlus extends CrosshairClassic {
    private boolean dynamicWeaponGap;

    public CrClassicStaticPlus() {
        color = new CrColor();
        color.setColorMode(CrColor.ColorMode.CUSTOM);
        color.setCustomColor(Color.CYAN);
        size = 2;
        thickness = 0.5;
        gap = -1;
        dot = false;
    ...
    public CrClassicStaticPlus(CrClassicStaticPlus crosshair) {
    ...
    public String getInfo() {
        return "-Fully customizable\n-Crosshairgap only expands when shooting\n-Weapon based gap\n can be turned\n on and off\n-Custum color";
    }
    ...
    public Crosshair copy() {
        return new CrClassicStaticPlus(this);
    }
